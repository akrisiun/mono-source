...
{  
   ...
   [Guid("95e37562-50db-339c-95f7-e67f28dde94b")]
   public class DialogBackend : WindowBackend Xwt.Backends.IDialogBackend
   {
       ...
       public override void GetMetrics(out Xwt.Size minSize, out Xwt.Size decorationSize) {}
       public virtual void SetButtons(System.Collections.Generic.IEnumerable<Xwt.DialogButton> buttonList) {}
       public virtual void UpdateButton(Xwt.DialogButton b) {}
       public void UpdateButton(Xwt.DialogButton b, Xwt.Button realButton) {}
       public virtual void RunLoop(Xwt.Backends.IWindowFrameBackend parent) {}
       public virtual void EndLoop() {}
      // public virtual override void Initialize(Xwt.Backends.IWindowFrameEventSink eventSink) {}
       public virtual override void Present() {}
       ...
       protected virtual override void OnBoundsChanged() {}
       public virtual override void UpdateChildPlacement(Xwt.Backends.IWidgetBackend childBackend) {}
       public virtual override void SetPadding(double left, double top, double right, double bottom) {}
       public virtual override void SetMainMenu(Xwt.Backends.IMenuBackend menu) {}
       protected virtual override void Dispose(bool disposing) {}
       public override void DragStart(Xwt.TransferDataSource data, Xwt.DragDropAction dragAction, object dragImage, double xhot, double yhot) {}
       public override void SetDragSource(string[] types, Xwt.DragDropAction dragAction) {}
       public override void SetDragTarget(string[] types, Xwt.DragDropAction dragAction) {}
       public virtual override void SetMinSize(Xwt.Size s) {}
       public virtual override void SetIcon(Xwt.Backends.ImageDescription icon) {}
       public override void LayoutContent(CoreGraphics.CGRect frame) {}
      ...
      public virtual Xwt.DialogButton DefaultButton { get; set; }
      public virtual IntPtr NativeHandle { get { throw new NotImplementedException(); } }
      public Xwt.Backends.IWindowFrameEventSink EventSink { get { throw new NotImplementedException(); } }
      ...
      public AppKit.INSWindowDelegate Delegate { get; set; }
