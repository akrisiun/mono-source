...
{  
   ...
   [Guid("326bdff8-1e38-3dec-b6a4-444aeff971f4")]
   public sealed class MacSpinButton : WidgetView
   {
       ...
       public void SetButtonStyle(Xwt.ButtonStyle style) {}
      ...
      // ctor: 
   // public MacSpinButton (Xwt.Backends.ISpinButtonEventSink eventSink, Xwt.Backends.ApplicationContext context) {}
      ...
      public string IndeterminateMessage { get; set; }
