...
{  
   ...
   [Guid("c3ce1108-660f-3c60-9a1d-79c22c7a7bc2")]
   public class WebViewBackend : ViewBackend<WebKit.WebView,Xwt.Backends.IWebViewEventSink> Xwt.Backends.IWebViewBackend
   {
       ...
       public virtual void LoadHtml(string content, string base_uri) {}
      ...
      public virtual double LoadProgress { get { throw new NotImplementedException(); } }
      public virtual bool CanGoBack { get { throw new NotImplementedException(); } }
      public virtual bool CanGoForward { get { throw new NotImplementedException(); } }
      public virtual bool ContextMenuEnabled { get; set; }
      public virtual bool DrawsBackground { get; set; }
      public virtual bool ScrollBarsEnabled { get; set; }
      public virtual string CustomCss { get; set; }
      protected new Xwt.Backends.IWebViewEventSink EventSink { }
      public WebKit.WebView Widget { get { throw new NotImplementedException(); } }
