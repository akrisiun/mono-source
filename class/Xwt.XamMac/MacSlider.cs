...
{  
   ...
   [Guid("c29cbc2a-2d21-3f83-bc79-330494719603")]
   public class MacSlider : AppKit.NSSlider IViewObject
   {
       public override void ResetCursorRects() {}
       public static override AppKit.NSSlider FromTarget(Action action) { throw new NotImplementedException(); }
       public static override AppKit.NSSlider FromValue(double value, double minValue, double maxValue, Action action) { throw new NotImplementedException(); }
       ...
       public virtual override CoreGraphics.CGRect RectOfTick(nint index) { throw new NotImplementedException(); }
       public virtual override double TickMarkValue(nint index) { throw new NotImplementedException(); }
      ...
      public override bool AllowsVibrancy { get { throw new NotImplementedException(); } }
      ...
      public virtual Foundation.NSObject AccessibilityValue { get { throw new NotImplementedException(); } }
      public virtual bool AllowsTickMarkValuesOnly { get; set; }
      ...
      public virtual AppKit.NSColor TrackFillColor { get; set; }
