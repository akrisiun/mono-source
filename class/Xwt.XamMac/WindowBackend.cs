...
{  
   ...
   [Guid("c899e9d8-8ead-3a26-9b7d-63e4b302683c")]
   public class WindowBackend : AppKit.NSWindow Xwt.Backends.IWindowBackend
   {
      ...
      // public virtual void Initialize(Xwt.Backends.IWindowFrameEventSink eventSink) {}
       ...
       public virtual void SetMainMenu(Xwt.Backends.IMenuBackend menu) {}
      ...
      //ctor: 
      public WindowBackend (IntPtr ptr) {}
      //ctor: 
