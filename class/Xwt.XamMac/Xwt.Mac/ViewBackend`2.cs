...
{  
   ...
   [Guid("91f443c1-36ae-390e-97c7-374d87408821")]
   public abstract class ViewBackend`2 : ViewBackend
   {
      ...
      //ctor: 
      protected ViewBackend<T,S> () {}
      public new S EventSink { get { throw new NotImplementedException(); } }
      public new T Widget { get { throw new NotImplementedException(); } }
