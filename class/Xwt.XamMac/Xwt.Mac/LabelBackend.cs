...
{  
   ...
   [Guid("a40807de-ff91-3693-b26c-fea102e9ea66")]
   public class LabelBackend : ViewBackend<AppKit.NSView,Xwt.Backends.IWidgetEventSink> Xwt.Backends.ILabelBackend
   {
       ...
       public virtual void SetFormattedText(Xwt.FormattedText text) {}
      ...
      public LabelBackend () {}
      //ctor: 
      protected LabelBackend (Xwt.Mac.IViewObject view) {}
