...
{  
   ...
   [Guid("79cbeca2-0968-3f9b-8a3f-bc6377650a2f")]
   public class ColorPickerBackend : ViewBackend<AppKit.NSColorWell,Xwt.Backends.IColorPickerEventSink> Xwt.Backends.IColorPickerBackend
   {
      ...
      public virtual Xwt.Drawing.Color Color { get; set; }
      public virtual bool SupportsAlpha { get; set; }
      public virtual string Title { get; set; }
      public Xwt.Backends.IColorPickerEventSink EventSink { get { throw new NotImplementedException(); } }
      public AppKit.NSColorWell Widget { get { throw new NotImplementedException(); } }
