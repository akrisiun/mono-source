...
{  
   ...
   [Guid("09a53bd1-e0e7-38c4-a861-bb4ce73240b9")]
   public class DatePickerBackend : ViewBackend<AppKit.NSDatePicker,Xwt.Backends.IDatePickerEventSink> Xwt.Backends.IDatePickerBackend
   {
      ...
      public virtual DateTime MinimumDateTime { get; set; }
      public virtual DateTime MaximumDateTime { get; set; }
      public virtual Xwt.DatePickerStyle Style { get; set; }
      public Xwt.Backends.IDatePickerEventSink EventSink { get { throw new NotImplementedException(); } }
