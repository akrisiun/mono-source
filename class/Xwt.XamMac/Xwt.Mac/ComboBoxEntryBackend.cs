...
{  
   ...
   [Guid("d3c812e4-c03d-31e2-9241-d13aaed6d7b7")]
   public class ComboBoxEntryBackend : ViewBackend<AppKit.NSComboBox,Xwt.Backends.IComboBoxEventSink> Xwt.Backends.IComboBoxEntryBackend
   {
       ...
       public virtual void SetTextColumn(int column) {}
      ...
      public virtual Xwt.Backends.ITextEntryBackend TextEntryBackend { get { throw new NotImplementedException(); } }
      ...
      public AppKit.NSComboBox Widget { get { throw new NotImplementedException(); } }
