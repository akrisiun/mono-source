...
{  
   ...
   [Guid("3543e133-968b-3314-ab57-c99ca98d777a")]
   public class PanedBackend : ViewBackend<AppKit.NSSplitView,Xwt.Backends.IPanedEventSink> Xwt.Backends.IPanedBackend
   {
       ...
       public virtual void UpdatePanel(int panel, bool resize, bool shrink) {}
       public virtual void RemovePanel(int panel) {}
       public override void ReplaceChild(AppKit.NSView oldChild, AppKit.NSView newChild) {}
      ...
      public Xwt.Backends.IPanedEventSink EventSink { get { throw new NotImplementedException(); } }
      public AppKit.NSSplitView Widget { get { throw new NotImplementedException(); } }
