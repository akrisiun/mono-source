...
{  
   ...
   [Guid("8783afd7-5719-33bc-ac08-241e0ea9ee45")]
   public class NotebookBackend : ViewBackend<AppKit.NSTabView,Xwt.Backends.IWidgetEventSink> Xwt.Backends.INotebookBackend
   {
      ...
      public virtual int CurrentTab { get; set; }
      public virtual Xwt.NotebookTabOrientation TabOrientation { get; set; }
      public Xwt.Backends.IWidgetEventSink EventSink { get { throw new NotImplementedException(); } }
      public AppKit.NSTabView Widget { get { throw new NotImplementedException(); } }
