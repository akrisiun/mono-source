...
{  
   ...
   [Guid("0bc2f65f-dd57-3bfd-9862-e443a9747e25")]
   public class SpinButtonBackend : ViewBackend<Xwt.Mac.MacSpinButton,Xwt.Backends.ISpinButtonEventSink> Xwt.Backends.ISpinButtonBackend
   {
      ...
      public virtual double ClimbRate { get; set; }
      ...
      public virtual double IncrementValue { get; set; }
      public virtual string IndeterminateMessage { get; set; }
      public virtual bool IsIndeterminate { get; set; }
      public Xwt.Backends.ISpinButtonEventSink EventSink { get { throw new NotImplementedException(); } }
      public MacSpinButton Widget { get { throw new NotImplementedException(); } }
