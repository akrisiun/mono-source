...
{  
   ...
   [Guid("223154e2-22f9-32ff-8431-c76747a7fb2a")]
   public class RadioButtonBackend : ViewBackend<AppKit.NSButton,Xwt.Backends.IRadioButtonEventSink> Xwt.Backends.IRadioButtonBackend
   {
      ...
      public Xwt.Backends.IRadioButtonEventSink EventSink { get { throw new NotImplementedException(); } }
