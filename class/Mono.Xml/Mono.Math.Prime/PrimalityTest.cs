...
{  
   ...
   [Guid("c9ea7f9d-4f8d-3520-80e8-7131bc0d2fd4")]
   public sealed delegate PrimalityTest : System.MulticastDelegate
   {
       public virtual bool Invoke(Mono.Math.BigInteger bi, ConfidenceFactor confidence) { throw new NotImplementedException(); }
       public virtual IAsyncResult BeginInvoke(Mono.Math.BigInteger bi, ConfidenceFactor confidence, AsyncCallback callback, object object) { throw new NotImplementedException(); }
