...
{  
   ...
   [Guid("136f13c9-5d15-31ca-a589-0016929db467")]
   public sealed delegate CertificateValidationCallback : System.MulticastDelegate
   {
       public virtual bool Invoke(System.Security.Cryptography.X509Certificates.X509Certificate certificate, int[] certificateErrors) { throw new NotImplementedException(); }
       public virtual IAsyncResult BeginInvoke(System.Security.Cryptography.X509Certificates.X509Certificate certificate, int[] certificateErrors, AsyncCallback callback, object object) { throw new NotImplementedException(); }
      ...
      //ctor: 
      public CertificateValidationCallback (object object, IntPtr method) {}
